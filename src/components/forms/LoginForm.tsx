...
export default function LoginForm() {
  return (
    <div className="border-color-form lg:border rounded-md flex-1 self lg:max-w-[792px] lg:max-h-[867px] h-[100%] w-[80%] flex self-center items-center justify-center flex-col">
